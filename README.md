...
|:---:|:---|:---:|:---:|
| 🎤 **Speak & Shine** | Production-ready full-stack English speaking practice platform. Daily AI-scored video submissions with speech analysis (fluency, grammar, confidence, vocabulary) powered by **Whisper Large v3** (transcription), **Llama 3.3 70B** (speech scoring & question generation), **Llama 4 Scout** (visual analysis) via Groq API, **LanguageTool** for grammar cross-checking, **RNNoise WASM** for browser-side noise cancellation. Streak tracking with fine/reward system, real-time group chat & live session rooms via Socket.io, community video feed with reactions & comments, admin dashboard, WhatsApp bot integration, direct-to-R2 video uploads with browser frame extraction, PWA support. **Security:** JWT rotation with refresh token reuse detection, Argon2 hashing with auto bcrypt→argon2 upgrade, account lockout, RBAC (admin/trainer/user/viewer), full CSP + HSTS via Helmet, SSRF protection, magic byte + codec validation on uploads, ClamAV virus scanning, AI content moderation, Redis-cached security scan results. | ![Node.js](https://img.shields.io/badge/Node.js-339933?style=flat-square&logo=node.js&logoColor=white) ![Express](https://img.shields.io/badge/Express-000000?style=flat-square&logo=express&logoColor=white) ![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black) ![MongoDB](https://img.shields.io/badge/MongoDB-47A248?style=flat-square&logo=mongodb&logoColor=white) ![Redis](https://img.shields.io/badge/Redis-DC382D?style=flat-square&logo=redis&logoColor=white) ![Socket.io](https://img.shields.io/badge/Socket.io-010101?style=flat-square&logo=socket.io&logoColor=white) ![Groq](https://img.shields.io/badge/Groq_API-F55036?style=flat-square&logoColor=white) ![Cloudflare R2](https://img.shields.io/badge/Cloudflare_R2-F38020?style=flat-square&logo=cloudflare&logoColor=white) | [📦 Repo](https://github.com/SidharthT-TechExpert/Speak-Shine-.git) · [🌐 Live](https://speak-shine.sidhartht.online) |
